...
def bact():
    ...
    def exit():
        window1.destroy()
    rem = "The remedies for burned Spot are:\n\n "
...
def analysis():
    ...
    verify_dir = 'D:/workspace/git_scr/BurnedPizzaClassifier/data/pizza/test/normal'
    IMG_SIZE = 50
    LR = 1e-3
...
def openphoto():
    dirPath = "D:/workspace/git_scr/BurnedPizzaClassifier/data/pizza/test/normal"
    ...
    fileName = askopenfilename(initialdir='D:/workspace/git_scr/BurnedPizzaClassifier/data', title='Select image for analysis ',
                           filetypes=[('image files', '.jpg')])
    dst = "D:/workspace/git_scr/BurnedPizzaClassifier/data'"
